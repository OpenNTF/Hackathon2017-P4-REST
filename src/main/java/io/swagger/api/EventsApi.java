...
public interface EventsApi {
    ...
    ResponseEntity<Event> eventsEventIdPost(@ApiParam(value = "The ID of the event.",required=true ) @PathVariable("eventId") String eventId);
    ...
    ResponseEntity<Event> eventsEventIdPut(@ApiParam(value = "The ID of the event.",required=true ) @PathVariable("eventId") String eventId);
