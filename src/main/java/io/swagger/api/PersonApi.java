...
public interface PersonApi {
    ...
    ResponseEntity<Person> personPersonIdPost(@ApiParam(value = "The ID of the person.",required=true ) @PathVariable("personId") String personId);
    ...
    ResponseEntity<Person> personPersonIdPut(@ApiParam(value = "The ID of the person.",required=true ) @PathVariable("personId") String personId);
